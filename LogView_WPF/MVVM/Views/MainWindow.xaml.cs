...
namespace LogViewer.MVVM.Views
{
    ...
    public partial class MainWindow : Window, IDisposable
    {
        ...
        #endregion Нажатие на чекбоксы дерева логгеров
        ...
        #endregion Сортировка по нажатию на заголовок таблицы
        ...
        #endregion Передача параметров в другую аппу, если существует
