...
namespace LogViewer.MVVM.ViewModels
{
    public class LogViewModel : BaseViewModel, IDisposable
    {
        ...
        private List<LogMessage> currentWarnLoggers = new List<LogMessage>();
        ...
        private List<LogMessage> currentErrorLoggers = new List<LogMessage>();
        ...
        private List<string> showOnlyThisLoggers = new List<string>();
        ...
        private List<Node> exceptParents = new List<Node>();
        ...
        #endregion Поиск и очистка поиска логгеров в дерев
        ...
        #endregion Остальные private методы
